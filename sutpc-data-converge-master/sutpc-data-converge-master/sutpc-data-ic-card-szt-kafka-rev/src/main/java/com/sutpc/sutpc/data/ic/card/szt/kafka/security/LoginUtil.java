package com.sutpc.sutpc.data.ic.card.szt.kafka.security;
...
public class LoginUtil {
   ...
   */
  private static final String SUN_LOGIN_MODULE =
  ...
  public static void setJaasFile(String principal, String keytabPath)
      throws IOException {
    String jaasPath =
        new File(System.getProperty("java.io.tmpdir")) + File.separator + System
  ...
  public static void setZookeeperServerPrincipal(String zkServerPrincipal)
    ...
    if (!ret.equals(zkServerPrincipal)) {
      throw new IOException(
          ZOOKEEPER_AUTH_PRINCIPAL + " is " + ret + " is not " + zkServerPrincipal + ".");
    }
  }
  ...
  public static void setKrb5Config(String krb5ConfFile)
    ...
    if (!ret.equals(krb5ConfFile)) {
      throw new IOException(
          JAVA_SECURITY_KRB5_CONF + " is " + ret + " is not " + krb5ConfFile + ".");
    }
  }
