...
import com.sutpc.bigdata.schema.hive.{STD_GPS_ORDER, s_vai_flow_pedestrian}
...
/**
  * <p>Description:TODO 视频AI 行人流量识别事件子表 清洗到标准库-s_vai_flow_pedestrian </p>
  * <p>Copyright: Copyright (c) 2019</p>
  * <p>Company: 深圳市城市交通规划研究中心</p>
  *
  * @author raomin
  * @version 1.0.0
  * @date date 2020/5/12 17:32
  */

/**
  * wiki说明: http://wiki.sutpc.org/pages/viewpage.action?pageId=38961326#id-11-%E8%A7%86%E9%A2%91AI%E4%B8%BB%E9%A2%98-%E8%A1%8C%E4%BA%BA%E6%B5%81%E9%87%8F%E8%AF%86%E5%88%AB%E4%BA%8B%E4%BB%B6%E5%AD%90%E8%A1%A8s_vai_flow_pedestrian
  * 原始数据存储目录: http://10.3.3.20:8889/hue/filebrowser/view=/data/origin/vai/flowRider#/data/origin/vai/flowPedestrian
  * 数据格式样例: {"area_num":14,"bayonet_direction":1,"density":null,"end_time":1589183625,"event_fid":"","flow_direction":2,"id":null,"in_num":12,"out_num":14,"sample_dura":25,"speed":1.11,"start_time":1589183600,"type":"flowPedestrian","wait_num":3}
  */
class VideoAiFlowPedestrian202005(spark: SparkSession, task: EtlTask) extends BaseTask[STD_GPS_ORDER] {
  ...
  override def process(dir: String): Unit = {
    ...
    res.show(10, false)
    TaskOutput.hive[s_vai_flow_pedestrian](spark, task, Array("city", "year", "month", "day"), res, isPersist = false, dupliCols = Seq(""), isCopy2Tag = false)
  }
}
