...
import com.sutpc.bigdata.schema.hive.{STD_GPS_ORDER, s_vai_flow_bus_stop}
...
/**
  * <p>Description:TODO 视频AI 公交站台人流量识别事件子表 清洗到标准库-s_vai_flow_bus_stop </p>
  * <p>Copyright: Copyright (c) 2019</p>
  * <p>Company: 深圳市城市交通规划研究中心</p>
  *
  * @author raomin
  * @version 1.0.0
  * @date date 2020/5/12 19:23
  */

/**
  * wiki说明: http://wiki.sutpc.org/pages/viewpage.action?pageId=38961326#id-11-%E8%A7%86%E9%A2%91AI%E4%B8%BB%E9%A2%98-%E5%85%AC%E4%BA%A4%E7%AB%99%E5%8F%B0%E4%BA%BA%E6%B5%81%E9%87%8F%E8%AF%86%E5%88%AB%E4%BA%8B%E4%BB%B6%E5%AD%90%E8%A1%A8s_vai_flow_busstop
  * 原始数据存储目录: http://10.3.3.20:8889/hue/filebrowser/view=/data/origin/vai#/data/origin/vai/flowBusStop
  * 数据格式样例: {"area_num":5,"density":2.64,"end_time":1589183695,"event_fid":"","id":null,"in_num":3,"out_num":9,"sample_dura":30,"speed":5.55,"start_time":1589183695,"type":"flowBusStop","wait_num":5}
  */
class VideoAiFlowBusStop202005(spark: SparkSession, task: EtlTask) extends BaseTask[STD_GPS_ORDER] {
  ...
  override def process(dir: String): Unit = {
    ...
    res.show(10, false)
    TaskOutput.hive[s_vai_flow_bus_stop](spark, task, Array("city", "year", "month", "day"), res, isPersist = false, dupliCols = Seq(""), isCopy2Tag = false)
  }
}
