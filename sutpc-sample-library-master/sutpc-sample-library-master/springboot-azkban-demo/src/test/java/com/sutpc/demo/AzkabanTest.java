...
//     uploadZip(project); // 上传zip
  ...
  public static String packageZip(String project,String flow) throws Exception{
    File dir = new File("E:\\test\\azkaban\\test04");
    File file = FileUtils.getFile(dir,"2-python.py");
    File file2 = FileUtils.getFile(dir,"main.py");
    ...
    ZipFilesUtils.zip(Arrays.asList(file,file2,projectFile,flowFile),fileName);
    return fileName;
  }
  ...
  public static File buildFlowFile(File dir,String flow)throws IOException {
    ...
    String python = "python main.py --params \"{'input': [{'index': '1','db_id': '1','table_name': 'gps','where': 'city=440300 and fdate=20190521'}, {'index': '2','db_id': '2','table_name': 'ic','where': 'city=440300 and fdate=2019 and version=##'}],'output': [{'index': '1','db_id': '1','table_name': 'result1'}, {'index': '2','db_id': '1','table_name': 'result2'}]}\"";
    
    nodes.add(buildAzJob("start_1","echo \"start!\"",null));
    nodes.add(buildAzJob("python_2","python 2-python.py \"${param1}\"", Arrays.asList("start_1")));
    nodes.add(buildAzJob("python_3",python, Arrays.asList("start_1")));
    nodes.add(buildAzJob("shell_3","echo \"shell3!\"",Arrays.asList("start_1")));
    nodes.add(buildAzJob("finish_4","echo \"finish!\"",Arrays.asList("python_2","python_3","shell_3")));
