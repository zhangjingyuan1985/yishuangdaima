...
def writeConfig(tableName,firstTag,firstTagValue,secondTag,secondTagValue):
    ...
    conf.write(open("vehicleConfig4.ini", "w"))
    return
#读取每张表最新的标记字段
def readLocalConfig():
    conf = configparser.ConfigParser();
    conf.read("vehicleConfig4.ini");
...
def run(data):
    ...
    schedule.every().day.at("05:00").do(doDayUpdate,dataForDay);
...
if __name__ == '__main__':
    configPath = r"E:\transPass_test\vehicle_topic\LoadDataForVehicleTopic4.xlsx";
